 ...
 */
public class MSF3DirParallel<V, E>  {
	 ...
	 */
	public MSF3DirParallel(Graph<V, E> graph, int numberOfThreads) {
		this.graph = graph;
	 ...
	 */
	public void execute()  {
		MSF3Dir<V, E> counter = new MSF3Dir<>(graph);
	...
	/**
	 * Find oriented 3-subgraphs author Yudin Evgeniy, Yudina M.
	 */
